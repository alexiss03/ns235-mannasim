...
///
#ifndef __resignation_data__
#define __resignation_data__
...
class ResignationData : public AppData
{
	public:

		/// Contructors
		ResignationData();
		ResignationData(AppDataType type);
		ResignationData(ResignationData &data);
