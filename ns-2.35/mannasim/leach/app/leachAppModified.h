...
/*
The current cluster head detects low power,
tries to send a challenge node to a
cluster node, accepts defeat if the challenger
...
class LeachAppWithResignation : public CommonNodeApp //SensorBaseApp
{
	protected:
